...
class SignDialog2 extends StatefulWidget {
  ...
  final int dWilaya;
  final int dStatus;
  SignDialog2(this.updateSign, this.row_date, [this.dStatus, this.dWilaya]);
  @override
...
class _SignDialog2State extends State<SignDialog2> {
  ...
  @override
  void initState()  {
    if (widget.dStatus!= null) _status = widget.dStatus;
    if (widget.dWilaya!= null) _wilaya = widget.dWilaya;
    super.initState();
  }
